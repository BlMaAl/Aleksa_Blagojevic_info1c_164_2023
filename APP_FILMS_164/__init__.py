...
try:
    ...
    from APP_FILMS_164.genres import gestion_genres_wtf_forms
    ...
    from APP_FILMS_164.Image import gestion_images_crud
    from APP_FILMS_164.Image import gestion_image_wtf_forms
