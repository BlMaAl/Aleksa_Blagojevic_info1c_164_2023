...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante (WTF) dont le contenu est basé sur la table "t_utilisateurs"
...
class DemoFormSelectWTF(FlaskForm):
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplisutilisateur = SubmitField("Choix genre")
